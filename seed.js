...
correctAnswer: 2
  ...
  },
  {
    ...
    correctAnswer: 1
          ...
          { videoId: "m1s3-v4", title: "Daily discipline", 
           url: "https://all-exowa-training-video.netlify.app/disciplin_banaye.mp4", 
           sequenceOrder: 12, 
           quiz: [
  {
    question: "Daily Discipline का क्या अर्थ है?",
    options: [
      "पूरा दिन लगातार काम करना",
      "रोज़ाना नियमित रूप से सही काम करना",
      "सिर्फ Motivation आने पर काम करना",
      "सप्ताह में एक बार काम करना"
    ],
    correctAnswer: 1
  },
  {
    question: "स्क्रिप्ट के अनुसार सफलता कैसे बनती है?",
    options: [
      "एक बड़े काम से",
      "किस्मत से",
      "रोज़ किए गए छोटे-छोटे कामों से",
      "सिर्फ Talent से"
    ],
    correctAnswer: 2
  },
  {
    question: "दो महिलाओं की कहानी में कौन सफल होती है?",
    options: [
      "जो कभी-कभी बहुत ज्यादा काम करती है",
      "जो रोज़ थोड़ा-थोड़ा काम करती है",
      "जो सिर्फ Training देखती है",
      "जो केवल Messages भेजती है"
    ],
    correctAnswer: 1
  },
  {
    question: "स्क्रिप्ट के अनुसार सफलता Talent से नहीं बल्कि किससे बनती है?",
    options: [
      "Luck",
      "Experience",
      "Consistency",
  ...
  {
    question: "Daily Discipline का सही मतलब क्या है?",
    options: [
      "पूरे दिन काम करना",
      "रोज़ थोड़ा-थोड़ा सही काम करना",
      "सिर्फ छुट्टी वाले दिन काम करना",
      "केवल Calls करना"
    ],
    correctAnswer: 1
  },
  {
    question: "पहली Daily Habit क्या है?",
    options: [
      "रोज़ लोगों से जुड़ना",
      "रोज़ सीखना",
      "रोज़ Practice करना",
      "रोज़ Sales करना"
    ],
  ...
  {
    question: "रोज़ सीखने में क्या शामिल है?",
    options: [
      "Training देखना",
      "नई Skills सीखना",
      "नई जानकारी सीखना",
  ...
  {
    question: "दूसरी Daily Habit क्या है?",
    options: [
      "रोज़ Practice करना",
      "रोज़ लोगों से जुड़ना",
      "रोज़ आराम करना",
      "रोज़ Sales Report बनाना"
    ],
    correctAnswer: 1
  },
  {
    question: "रोज़ लोगों से जुड़ने के कौन-कौन से तरीके बताए गए हैं?",
    options: [
      "Phone Call",
      "WhatsApp",
      "Follow-up",
  ...
  {
    question: "तीसरी Daily Habit क्या है?",
    options: [
      "रोज़ Practice करना",
      "रोज़ Shopping करना",
      "रोज़ Travel करना",
  ...
  {
    question: "चौथी Daily Habit क्या है?",
    options: [
      "रोज़ Income गिनना",
      "रोज़ अपने लक्ष्य (Why) को याद करना",
      "रोज़ छुट्टी लेना",
      "रोज़ Video बनाना"
    ],
    correctAnswer: 1
  ...
  {
    question: "जब आपका 'Why' मजबूत होगा तो क्या मजबूत होगा?",
    options: [
      "Income",
      "Confidence",
      "Discipline",
  ...
  {
    question: "Discipline और Motivation में क्या अंतर है?",
    options: [
      "दोनों एक जैसे हैं",
      "Motivation हर दिन काम करता है",
      "Discipline हर दिन काम करता है, Motivation बदलता रहता है",
      "Motivation ज्यादा महत्वपूर्ण है"
    ],
    correctAnswer: 2
  },
  {
    question: "अगर किसी दिन मन न करे तो सफल महिलाएं क्या करती हैं?",
    options: [
      "काम छोड़ देती हैं",
      "अगले सप्ताह काम करती हैं",
      "अपने छोटे-छोटे काम पूरे करती हैं",
      "सिर्फ आराम करती हैं"
    ],
    correctAnswer: 2
  },
  {
    question: "स्क्रिप्ट के अनुसार कौन-सी बात समस्या नहीं है?",
    options: [
      "एक दिन का काम छोड़ना",
      "बार-बार काम छोड़ना",
      "Practice करना",
      "Training देखना"
    ],
  ...
  {
    question: "यदि आप रोज़ केवल 1% बेहतर बनती हैं तो क्या होगा?",
    options: [
      "कोई फर्क नहीं पड़ेगा",
      "एक साल बाद कई गुना आगे होंगी",
      "काम कठिन हो जाएगा",
      "फिर से शुरुआत करनी पड़ेगी"
    ],
    correctAnswer: 1
  },
  {
    question: "उदाहरण वाले Daily Routine में क्या शामिल था?",
    options: [
      "15 मिनट Training",
      "10 Calls",
  ...
  {
    question: "Exowa Women Partner Program में सफलता का Formula क्या है?",
    options: [
      "केवल Sales करना",
      "केवल Training देखना",
      "सीखो, लोगों से जुड़ो, रोज़ थोड़ा काम करो और लगातार आगे बढ़ो",
      "सिर्फ Motivation रखना"
    ],
    correctAnswer: 2
  },
  {
    question: "इस Training का अंतिम संदेश क्या है?",
    options: [
      "सफलता केवल बड़े कदमों से मिलती है",
      "रोज़ छोटे-छोटे अनुशासित कदम बड़ी सफलता बनाते हैं",
      "सिर्फ Talent से सफलता मिलती है",
      "केवल Experience ही सफलता दिलाता है"
    ],
    correctAnswer: 1
  }
] }
